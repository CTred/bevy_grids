...
use coordinates::{
    Coords, HexCoord, HexOrientation, SquareCoord, TriangleCoord, TriangleNeighbours,
};
...
#[derive(Resource)]
pub struct GridMap<K>(HashMap<K, Entity>)
where
    K: Coords;
...
impl GridPlugin<Triangles> {
    pub fn new(primitive: Triangles) -> Self {
